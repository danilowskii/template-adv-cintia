        ...
        <div className="flex justify-between items-center h-24">
          ...
          <div className="hidden md:flex">
            <a
              href={wppLink}
              target="_blank"
              className={`relative overflow-hidden group bg-gradient-to-r from-[var(--secondary)] to-[var(--primary)] text-[var(--bg)] px-8 py-3 rounded-sm text-sm font-bold shadow-white hover:shadow-gray-300 transition-all duration-300`}
            >
